                ...
                <ReceiptPaper>
                    ...
                    <Box sx={{ mb: 4 }}>
                        ...
                        <DetailRow>
                            ...
                            <ValueText variant="body2">{metadata.sender_bank || 'N/A'}</ValueText>
                        </DetailRow>
                    </Box>
                    ...
                    <Box sx={{ mb: 4 }}>
                        ...
                        <DetailRow>
                            <Typography variant="body2" color="text.secondary">Virtual Account</Typography>
                            <ValueText variant="body2" sx={{ fontFamily: 'monospace' }}>{transaction.va_account_number || 'N/A'}</ValueText>
                        </DetailRow>
                        <DetailRow>
                            <Typography variant="body2" color="text.secondary">Account Name</Typography>
                            <ValueText variant="body2">{transaction.va_account_name || 'N/A'}</ValueText>
                        </DetailRow>
                    </Box>
                    ...
                    <Box sx={{ mb: 4 }}>
                        ...
                        <DetailRow>
                            ...
                            <ValueText variant="body2">₦{fCurrency(transaction.charges || transaction.fee || 0)}</ValueText>
                        </DetailRow>
                    ...
                    <Box sx={{ textAlign: 'center', mt: 4, pt: 4, borderTop: `1px solid ${theme.palette.divider}` }}>
                        <Typography variant="caption" sx={{ color: 'text.disabled', display: 'block', mb: 2 }}>
                            This is an automated transaction receipt generated by PointPay.
                        </Typography>
