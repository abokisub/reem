        ...
        try {
            ...
            $transaction = Transaction::create([
                ...
                'metadata' => [
                    ...
                    'narration' => $narration,
                    'fee_model' => $feeResults['breakdown']['fee_model'] ?? $feeResults['source'],
                    'fee_type' => $feeResults['breakdown']['percentage_fee'] > 0 ? 'PERCENT' : 'FLAT',
                    'fee_value' => $feeResults['breakdown']['percentage_fee'] > 0 ? $feeResults['breakdown']['percentage_fee'] : $feeResults['breakdown']['flat_fee'],
                    'fee_cap' => $feeResults['breakdown']['cap_amount'] ?? null,
