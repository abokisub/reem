...
$paths = [
    '/api/v2/virtual-account/bank/list',
    '/api/v2/virtualaccount/bank/list',
    '/api/v2/virtual-account/queryBankList',
    '/api/v2/virtualaccount/queryBankList',
];
...
foreach ($paths as $path) {
    ...
    $signature = $signatureService->generateSignature($params);
