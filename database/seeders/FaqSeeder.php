    ...
    public function run()
    {
        \DB::table('faqs')->insert([
            ...
            [
                ...
                'answer' => 'You can reach us via our live chat ("Aboki"), send an email to our support team, or contact us through WhatsApp. Our support channels are available 24/7.',
                'category' => 'Support',
                'status' => 1,
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                'question' => 'What is the "Aboki" AI Chat?',
                'answer' => 'Aboki is our smart AI support assistant designed to provide instant answers to your questions. For complex issues, Aboki can also connect you to a human agent.',
                'category' => 'Support',
                'status' => 1,
                'created_at' => now(),
                'updated_at' => now(),
